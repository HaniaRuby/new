...
<body>
      ...
      <div class="container position-relative">
        <div class="site-navigation text-center dark">
          ...
          <ul class="js-clone-nav pl-0 d-none d-lg-inline-block site-menu">
            <li><a href="index.php?ip=<?php echo $ip?>">Home</a></li>
            <li class="active"><a href="shop.php?ip=<?php echo $ip?>">Shop</a></li>
    ...
    <div class="container">
      <div class="row align-items-end text-center">
        <div class="col-lg-7 mx-auto">
          <h1>Shop</h1>  
          <p class="mb-4"><a href="index.php?ip=<?php echo $ip?>">Home</a> / <strong>Shop</strong></p>        
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="untree_co-section pt-3">
    ...
    <?php endforeach; ?>
            ...
            <!-- <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
              <div class="product-item">
                <a href="shop-single.php?ip=<?php echo $ip?>" class="product-img">
