...
$ip= "999";//$_SERVER['REMOTE_ADDR'];
$user->setip($ip);
$usercont->signup($user);
...
<body>
				...
				<div class="container position-relative">
					<div class="site-navigation text-center dark">
						...
						<ul class="js-clone-nav pl-0 d-none d-lg-inline-block site-menu">
							...
							<li><a href="shop.php?ip=<?php echo $ip?>">Shop</a></li>
							<li><a href="cart.php?ip=<?php echo $ip?>">Cart</a></li>
						</ul>
					...
					<div class="container">
						<div class="row align-items-center">
							<div class="col-lg-6">
								...
								<h1 class="mb-4 heading" data-aos="fade-up" data-aos-delay="100">Sell products the easy way with MYTHE Store </h1>
					...
					<div class="container">
						<div class="row align-items-center">
							<div class="col-lg-6">
								...
								<h1 class="mb-4 heading" data-aos="fade-up" data-aos-delay="100">The New Way To Sell Your Products by MYTHE Store  </h1>
								<div class="mb-5 text-white desc mx-auto" data-aos="fade-up" data-aos-delay="200">
								</div>
    ...
    <?php foreach ($allProducts as $product): ?>
        <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
            <div class="product-item">
                <a href="shop-single.php?id=<?php echo urlencode($product['id']); ?>" class="product-img">
